  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 p-6">
      ...
      <nav className="flex justify-center relative z-10">
                <ul className="flex space-x-2 sm:space-x-4 lg:space-x-8 font-inter">
          {navItems.map((item, index) => (
            <li key={item.number} className="flex items-center space-x-2">
              ...
              <button
                ...
                className={`text-sm sm:text-base lg:text-lg font-semibold whitespace-nowrap transition-all duration-300 hover:rotate-y-12 ${
