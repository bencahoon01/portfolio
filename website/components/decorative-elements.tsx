...
export default function DecorativeElements() {
  return (
    <>
      ...
      <div className="absolute top-30 right-[8.33%] z-30 text-foreground font-mono text-lg font-bold">20XX</div>
      <div className="absolute top-30 left-[8.33%] z-30 text-foreground font-mono text-lg font-bold">2025</div>
