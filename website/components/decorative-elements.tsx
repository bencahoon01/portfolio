...
export default function DecorativeElements() {
  return (
    <>
      ...
      <div className="fixed top-32 left-1/4 z-10 text-foreground text-2xl">♦</div>
      <div className="fixed top-40 right-1/3 z-10 text-foreground text-xl">✕</div>
      <div className="fixed top-28 right-1/4 z-10 text-foreground text-2xl">♦</div>

      {/* Middle row decorative elements */}
      <div className="fixed top-1/2 left-16 z-10 text-foreground text-xl">✕</div>
      <div className="fixed top-1/2 right-16 z-10 text-foreground text-xl">✕</div>

      {/* Bottom row decorative elements */}
      <div className="fixed bottom-32 left-1/3 z-10 text-foreground text-2xl">♦</div>
      <div className="fixed bottom-40 right-1/4 z-10 text-foreground text-xl">✕</div>
      <div className="fixed bottom-28 left-1/4 z-10 text-foreground text-2xl">♦</div>
