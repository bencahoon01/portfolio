...
const projects = [
  {
    ...
    description: "A full-stack project in collaboration with NIWC Atlantic and Clemson to design and develop an AI-assisted, modular, and scalable training platform.",
  ...
  },
  {
    ...
    image: "/placeholder.svg",
    description: "Developed a Chrome extension using React, TypeScript, and Tailwind CSS for AI-assisted responses. Integrated OpenAI API and plans to migrate to AWS services, including Bedrock's knowledge base, for enhanced scalability and tailored AI functionality.",
