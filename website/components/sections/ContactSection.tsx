      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            <motion.a
              href="/resume.pdf"
              download="Ben_Cahoon_Resume.pdf"
              className="inline-flex items-center gap-3 px-6 py-3 border-2 border-foreground text-foreground hover:bg-foreground hover:text-background transition-all duration-300 font-mono text-sm tracking-wider"
          ...
          >
            ...
            <motion.a
              href="https://discord.gg/your-discord-username"
              target="_blank"
              rel="noopener noreferrer"
              className="text-foreground hover:text-accent transition-colors duration-300"
              initial={{ opacity: 0, y: 20 }}
